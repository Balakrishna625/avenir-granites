    ...
    <DashboardLayout>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-3 md:gap-4">
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
          ...
          <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-gray-900 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.expectedTotal)}</div>
        </div>
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
          <div className="text-[10px] md:text-xs text-gray-600 uppercase tracking-wide truncate">Invoiced RTGS</div>
          <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-gray-900 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.expectedRTGS)}</div>
        </div>
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
          <div className="text-[10px] md:text-xs text-gray-600 uppercase tracking-wide truncate">Invoiced Cash</div>
          <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-gray-900 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.expectedCASH)}</div>
        </div>
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
          <div className="text-[10px] md:text-xs text-blue-600 uppercase tracking-wide truncate">Received RTGS</div>
          <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-blue-600 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.receivedRTGS)}</div>
        </div>
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
          <div className="text-[10px] md:text-xs text-green-600 uppercase tracking-wide truncate">Received Cash</div>
          <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-green-600 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.receivedCASH)}</div>
        </div>
        <div className="bg-white rounded-xl p-3 md:p-4 border shadow-sm min-w-0 overflow-hidden">
        ...
        {excludeGalaxy && kpi.effectiveGalaxyPayments > 0 && (
          <div className="bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl p-3 md:p-4 border-2 border-purple-200 shadow-sm min-w-0 overflow-hidden">
            <div className="text-[10px] md:text-xs text-purple-600 uppercase tracking-wide font-semibold truncate">Galaxy Payments</div>
            <div className="text-sm md:text-base lg:text-lg xl:text-xl font-bold text-purple-600 whitespace-nowrap overflow-hidden text-ellipsis">{fmt(kpi.effectiveGalaxyPayments)}</div>
